...
type ListenerEntryApplyConfiguration struct {
	...
	Port          *v1.OptionalPortNumber                     `json:"port,omitempty"`
...
func (b *ListenerEntryApplyConfiguration) WithPort(value v1.OptionalPortNumber) *ListenerEntryApplyConfiguration {
	b.Port = &value
	return b
}
